...
def perguntar():
    ...
    #Comparar a pergunta do usuario (embedding)com meu banco de dados
    ...
    modelo=ChatOpenAI()
    textos_resultado = modelo.invoke(prompt).content
    print("Resposta da IA" , textos_resultado)
perguntar()